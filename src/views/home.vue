<template>
  <div class="h-dvh flex flex-col items-center justify-center gap-8 bg-stone-950">
    ...
    <a class="rounded-md py-2 px-5 bg-[#9146FF] flex text-white gap-4 items-center"
       href="https://id.twitch.tv/oauth2/authorize?response_type=token&client_id=oe33kkiax4rchm0eelzlbradrr8zur&redirect_uri=http://localhost:5173&scope=">
      <div class="w-6 h-6">
